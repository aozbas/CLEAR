...
-- 1. Auto-create a profiles row whenever a new user signs up via Hosted database Auth.
-- 2. Add schema-level guardrails on the scans table (confidence range, valid labels).

-- ============================================================
-- 1. Profile auto-creation trigger
-- ============================================================
-- Hosted database Auth writes to auth.users on sign-up but does NOT touch public.profiles.
