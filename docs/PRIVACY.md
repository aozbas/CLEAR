...
| Third parties | No Supabase, analytics, crash-reporting, advertising, or account SDK is used in the public flow | Audit hosting, DNS, TLS, app-store, and observability providers and their retention terms |
