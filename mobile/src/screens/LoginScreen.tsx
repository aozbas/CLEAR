...
import { hosted_database } from "../lib/hosted_database";
...
export default function LoginScreen() {
  ...
  async function signIn() {
    ...
    setError(null);
    setInfo(null);
    const { error } = await hosted_database.auth.signInWithPassword({ email, password });
  ...
  async function signUp() {
    ...
    setError(null);
    setInfo(null);
    const { data, error } = await hosted_database.auth.signUp({ email, password });
    if (error) setError(error.message);
